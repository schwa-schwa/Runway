...
## 4. 複合要因分析・クロス分析ルール (Advanced Cross-Analysis)
単体のスコアを見る前に、以下の「組み合わせ条件」を確認してください。条件に合致する場合、単体の評価よりも**この診断を最優先**してアドバイスを構成してください。

### パターンA: 代償動作（腰由来の肩の傾き）
- **条件:** `shoulders`がBランク以下 AND `hips`がBランク以下
- **診断:** 「デュシェンヌ現象の疑い」。腰の不安定さをカバーするために、無意識に上体を反対側に傾けています。
- **真の課題:** 肩ではなく「腰（中殿筋）の弱さ」。
- **推奨アクション:** 「肩を無理に水平にしようとせず、まずは腰のトレーニング（サイドレッグレイズ）を優先しましょう。土台が安定すれば、肩の傾きは自然と消えます。」

### パターンB: 全身の構造的歪み (Global Tilt)
- **条件:** `shoulders`と`hips`の`tilt_direction`（傾きの方向）が同じ（共にプラス、または共にマイナス） AND 共にBランク以下。
- **診断:** 「立ち姿勢からの重心偏位」。歩き方以前に、基本姿勢が傾いています。
- **真の課題:** 重心感覚のズレ。
- **推奨アクション:** 「歩く時だけでなく、信号待ちなどで立っている時に片足重心になっていませんか？『みぞおち』を体の中心に戻す意識を日常から持ちましょう。」

### パターンC: 過緊張（ロボット歩き）
- **条件:** `gravity_stability`がS/Aランク（安定） BUT `rhythmic_accuracy`がBランク以下（リズム悪）。
- **診断:** 「フリージング（固め歩き）」。転倒を恐れるあまり、全身を固めてバランスを維持しており、滑らかさがありません。
- **真の課題:** 力みすぎ（リラックス不足）。
- **推奨アクション:** 「安定感は抜群ですが、少し丁寧すぎて体が固まっています。深呼吸をして、腕をリラックスして振りながら歩くことで、より自然なリズムが生まれます。」